...
class FolderConstants
{
    ...
    public const string ASSET_COLLECTIONS         = '/Collections';
    public const string ASSET_WEBSITE             = '/Website';
    public const string ASSET_WEBSITE_DOCUMENTS   = self::ASSET_WEBSITE.'/Documents';
    ...
    public const string OBJECT_COLLECTIONS     = '/Collections';
